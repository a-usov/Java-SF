...
\end{flalign*}
Therefore, if we pass to this method an argument of type \emph{Triangle}, as it is not contained in the computed set of subtypes, we get a typechecking error at compile type \cite{UD20}.
