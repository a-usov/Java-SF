...
% The complete type system and its soundness properties are presented in relevant work \cite{Dardha2013,Dardha2017} and are beyond the scope of this paper.
% However, let us briefly comment on typing terms in SFJ.
...
% Constants are typed by their basic type.

% Subtyping generated in \autoref{alg:subtyping} is used in a subsumssion typing rule:
% $$
