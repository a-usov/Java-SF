...
Thus, if we pass to \emph{diagonal} an argument of type \emph{Triangle}, we get a typechecking error at compile time, as illustrated in the accompanying video \cite{UD20}.
