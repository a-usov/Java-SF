...
Notice that the above types can be defined in Java. These types can be inhabited by assigning \emph{null} to all fields, but are not useful in practise.
